...
public class VertxGremlinClient {
  ...
  public static VertxGremlinClient create(Vertx vertx) {
    def ret= InternalHelper.safeCreate(com.monogram.vertx.gremlin.VertxGremlinClient.create((io.vertx.core.Vertx)vertx.getDelegate()), com.monogram.vertx.gremlin.VertxGremlinClient.class);
    return ret;
  }
  public static VertxGremlinClient createProxy(Vertx vertx, String address) {
    def ret= InternalHelper.safeCreate(com.monogram.vertx.gremlin.VertxGremlinClient.createProxy((io.vertx.core.Vertx)vertx.getDelegate(), address), com.monogram.vertx.gremlin.VertxGremlinClient.class);
    return ret;
  }
