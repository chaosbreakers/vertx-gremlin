...
*/
public class VertxGremlinClientVertxEBProxy implements VertxGremlinClient {
  ...
  public VertxGremlinClientVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public VertxGremlinClientVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
