...
*/
public class VertxGremlinClientVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final VertxGremlinClient service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public VertxGremlinClientVertxProxyHandler(Vertx vertx, VertxGremlinClient service) {
    this(vertx, service, DEFAULT_CONNECTION_TIMEOUT);
  }

  public VertxGremlinClientVertxProxyHandler(Vertx vertx, VertxGremlinClient service, long timeoutInSecond) {
    this(vertx, service, true, timeoutInSecond);
  }

  public VertxGremlinClientVertxProxyHandler(Vertx vertx, VertxGremlinClient service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
